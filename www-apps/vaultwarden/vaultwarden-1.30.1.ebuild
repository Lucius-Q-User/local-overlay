...
DESCRIPTION="Unofficial Bitwarden compatible server formerly known as bitwarden_rs"
HOMEPAGE="https://github.com/dani-garcia/vaultwarden"
SRC_URI="
	${CARGO_CRATE_URIS}
	https://github.com/dani-garcia/${PN}/archive/refs/tags/${PV}.tar.gz -> ${P}.tar.gz
	https://github.com/dani-garcia/bw_web_builds/releases/download/v2024.1.2/bw_web_v2024.1.2.tar.gz
"

# License set may be more restrictive as OR is not respected
# use cargo-license for a more accurate license picture
LICENSE="0BSD AGPL-3 Apache-2.0 Apache-2.0-with-LLVM-exceptions BSD BSD-2 Boost-1.0 ISC MIT MPL-2.0 Unicode-DFS-2016 Unlicense ZLIB"
SLOT="0"
KEYWORDS="~amd64"
...
src_compile() {
	...
	export LIBSQLITE3_SYS_USE_PKG_CONFIG=q
	cargo_src_compile
}
...
src_install() {
	...
	insinto /etc
	newins .env.template vaultwarden.cfg
	insinto /usr/lib/vaultwarden
	doins -r "${WORKDIR}/web-vault"
	systemd_dounit "${FILESDIR}/vaultwarden.service"
}
